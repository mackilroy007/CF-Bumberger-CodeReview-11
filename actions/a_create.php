...
<body>
    ...
    if ($_POST) {
        ...
        $sql = "INSERT INTO animals (animalName, img, gender, size, age, description, city, zip, address) VALUES ('$name', '$img', '$gender', '$size', '$age', '$description', '$city', '$zip', '$address')";
        if ($connect->query($sql) === TRUE) {
            echo "
            <div class='container text-center mt-5'>
                <h2 class='text-center m-4'>New Record Successfully Created</h2>
                <a href='../homeA.php'><button class='btn btn-dark' type='button'>Home</button></a>
