...
if ($_POST) {
   ...
   $sql = "UPDATE animals SET animalName = '$name', img = '$img', gender = '$gender', age = '$age', size = '$size',
            description = '$description', address = '$address', zip = '$zip', city = '$city' WHERE animalID = '$id'" ;
